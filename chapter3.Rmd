...
g1 <- ggplot(alc_hyp, aes(x=high_use, y= failures, col=high_use), geom_boxplot())+ geom_boxplot() + ggtitle("title here")
g2 <- ggplot(alc_hyp, aes(x=high_use, y= studytime, col=high_use)) + geom_boxplot() + ggtitle("title here")
g3 <- ggplot(alc_hyp, aes(x=high_use, y= famsup, col=high_use))+ geom_boxplot() + ggtitle("title here")
g4 <- ggplot(alc_hyp, aes(x=high_use, y= health, col=high_use))+ geom_boxplot() + ggtitle("title here")
